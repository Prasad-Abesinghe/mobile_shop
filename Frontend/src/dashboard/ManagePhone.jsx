          ...
          <tbody key={phone._id}>
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              ...
              <td class="px-6 py-4 text-right">
                <Link
                  className="font-medium mr-5 text-cyan-600 hover:underline"
                  to={`/admin/dashboard/edit-phones/${phone._id}`}
                >
                  <button className=" bg-cyan-600 px-4 py-1 font-semibold text-white rounded-md">
                    {" "}
                    Edit
                  </button>
                </Link>
                <button
                  ...
                  className=" bg-red-400 px-4 py-1 font-semibold text-white rounded-md"
                >
                  Delete
                </button>
              </td>
